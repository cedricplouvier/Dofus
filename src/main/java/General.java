...
public class General extends Main {
    ...
    public void zaapAstrubToMaisonCoffre1() throws InterruptedException, FindFailed, IOException {
        ...
        TimeUnit.SECONDS.sleep(5);
        s.rightClick(new Location(490, 135));
    ...
    public void maisonAstrubToAtelierMineur() throws FindFailed, InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(4);
        s.click(new Location(xRight, 400));
    ...
    public void zaapAstrubForetAstrub() throws FindFailed, InterruptedException {
        ...
        mapsZaapAstrubToForetAstrub.add(new Location(840, yUp));
        mapsZaapAstrubToForetAstrub.add(new Location(765, yUp));
        mapsZaapAstrubToForetAstrub.add(new Location(1050, yUp));
        mapsZaapAstrubToForetAstrub.add(new Location(xRight, 440));
        mapsZaapAstrubToForetAstrub.add(new Location(905, yUp));
        mapsZaapAstrubToForetAstrub.add(new Location(xLeft, 340));
    ...
    public void maisonAstrubToAterlierSculpteurArc() throws FindFailed, InterruptedException {
        ...
        s.click(new Location(900, 420));
        TimeUnit.SECONDS.sleep(3);
        s.click(new Location(xLeft, 350));
        TimeUnit.SECONDS.sleep(6);
        s.click(new Location(xLeft, 380));
        TimeUnit.SECONDS.sleep(6);
        s.click(new Location(xLeft, 310));
        TimeUnit.SECONDS.sleep(6);
        s.click(new Location(860, yUp));
        TimeUnit.SECONDS.sleep(6);
    ...
    public void maisonAstrubToAterlierBijoutierAmu() throws FindFailed, InterruptedException {
        ...
        s.click(new Location(900, 420));
        TimeUnit.SECONDS.sleep(5);
        s.click(new Location(775, yDown));
        TimeUnit.SECONDS.sleep(8);
        s.click(new Location(840, yDown));
        TimeUnit.SECONDS.sleep(8);
        s.click(new Location(835, yDown));
        TimeUnit.SECONDS.sleep(8);
        s.click(new Location(840, yDown));
        TimeUnit.SECONDS.sleep(8);
