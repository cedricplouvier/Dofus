...
public class Main {
    ...
    public static void abraglands() throws AWTException, InterruptedException {
        Robot robot = new Robot();
        TimeUnit.SECONDS.sleep(3);
        Keyboard kb = new DesktopKeyboard();
        Screen s = new Screen();
        Pattern goud = new Pattern("src/main/resources/img/Goud.png");
        Pattern abraBack = new Pattern("src/main/resources/img/abraBack.png");
        Pattern abraLeft = new Pattern("src/main/resources/img/abraLeft.png");
        Pattern abraRight = new Pattern("src/main/resources/img/abraRight.png");
        Pattern abraFront = new Pattern("src/main/resources/img/abraFront.png");
        Pattern PDA = new Pattern("src/main/resources/img/PDA.png");
        //Pattern capture = new Pattern("src/main/resources/img/capture.png");
        Pattern goudFight = new Pattern("src/main/resources/img/goudFight.png");
        //Pattern jugement = new Pattern("src/main/resources/img/jugement.png");
        Pattern abraFight = new Pattern("src/main/resources/img/abraFight.png").similar((float) 0.8);
        //Pattern fermer = new Pattern("src/main/resources/img/fermer.png");
        ...
        for (int i = 0; i < 180; i++) {
            try {
                ...
                TimeUnit.SECONDS.sleep(1);
                Location A = new Location(670, 430); //sculpteur scara
                //Location A = new Location(900, 350); // sculpteur
                s.click(A);
                Location B = new Location(630, 440);
                //Location B = new Location(730, 405);
                s.click(B);
                ...
                s.type(Key.F6);
                s.click(abraFight);
                s.mouseMove(new Location(1200, 460));
                s.type(Key.F1);
                ...
                if (s.exists(abraFight) != null) {
                    ...
                    s.type(Key.F3);
                    TimeUnit.SECONDS.sleep(1);
                    Location C = new Location(770, 480); //scara
                    //Location C = new Location(950, 410); //milli
                    s.click(C);
                    TimeUnit.SECONDS.sleep(1);
                    s.type(Key.F6);
                    s.click(abraFight);
